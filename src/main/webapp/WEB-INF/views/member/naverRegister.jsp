...
<meta charset="UTF-8">
<title>회원가입완료</title>
<link href="${pageContext.request.contextPath}/resources/css/naverRegister.css" rel="stylesheet">
...
<body>
	...
	<form id="naverRegister" action="${pageContext.request.contextPath}/member/naverRegisterPro" method="post">
		<div class="leadtext">처음 네이버 로그인을 통해 OSTicket을 이용하시는 경우 사이트에서 사용할 닉네임을 만들어야 합니다.</div>
