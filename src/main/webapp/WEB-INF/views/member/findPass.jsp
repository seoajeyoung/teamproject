...
<title>비밀번호 찾기</title>
<link
	href="${pageContext.request.contextPath}/resources/css/member/findIdPass.css"
	rel="stylesheet">

</head>
<body>
	<jsp:include page="/WEB-INF/views/ticket/top.jsp" />
	<form class="findForm" action="${pageContext.request.contextPath}/member/tempPass" method="post" style="margin-top: 10%;">
