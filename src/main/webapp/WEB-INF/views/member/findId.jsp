...
<form class="findForm" action="${pageContext.request.contextPath}/member/informId" method="post">
	<div class="findIdField">
		<span id="leadtext">네이버 계정의 아이디/비밀번호를 찾고자 하실 경우, 네이버 사이트의 아이디/비밀번호 찾기를 이용해 주세요.</span><br>
