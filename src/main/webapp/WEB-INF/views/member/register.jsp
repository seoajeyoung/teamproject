...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/script/register.js"></script>
</head>
<body>
	<jsp:include page="/WEB-INF/views/ticket/top.jsp" />
	<!-- 아이디 / 비밀번호 / 비밀번호확인 /생년월일 / 성별 / 이메일 / 휴대폰번호 / 버튼 -->
	<form id="signupForm" class="signupForm" autocomplete="off" action="${pageContext.request.contextPath}/member/registerPro" method="post">
