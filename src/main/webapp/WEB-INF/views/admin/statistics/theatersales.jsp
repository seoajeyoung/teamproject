...
<body id="page-top">
	...
	function fetchWeekSalesData(startDate, endDate) {
	    $.ajax({
	        url: '${pageContext.request.contextPath}/admin/statistics/movieWeekSalesSearch',
	        type: 'GET',
	        data: {
	...
	function fetchMonthSalesData(startMonth, endMonth) {
	    $.ajax({
	        url: '${pageContext.request.contextPath}/admin/statistics/movieMonthSalesSearch',
	        type: 'GET',
	        data: {
	...
	function updateWeekChart(weekSalesData) {
	    ...
	    const salesData = weekSalesData.map(data => parseInt(data.movie_TOTALSALES));
	    ...
	    const ctx = document.getElementById('weeklyMovieChart').getContext('2d');
	    const chartData = {
	        labels: labels,
	        datasets: [{
	            label: '영화 매출 (원)',
	...
	function updateMonthChart(monthSalesData) {
	    ...
	    const salesData = monthSalesData.map(data => parseInt(data.movie_TOTALSALES));
	    ...
	    const ctx = document.getElementById('monthlyMovieChart').getContext('2d');
	    const chartData = {
	        labels: labels,
	        datasets: [{
	            label: '영화 매출 (원)',
