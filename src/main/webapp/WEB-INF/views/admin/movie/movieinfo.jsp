                   ...
                   <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
    							...
    							<a href="${pageContext.request.contextPath}/admin/movie/movieupdate?MOVIE_NUM=${movieDTO.MOVIE_NUM}" class="btn btn-success btn-user">영화정보수정</a>
                                <a href="${pageContext.request.contextPath}/admin/movie/moviedelete?MOVIE_NUM=${movieDTO.MOVIE_NUM}" class="btn btn-danger btn-user">영화정보삭제</a>
								</div>
