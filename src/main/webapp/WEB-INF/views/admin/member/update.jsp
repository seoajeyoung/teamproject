...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Topbar -->
            <jsp:include page = "/WEB-INF/views/inc/top1.jsp"/>
            <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/member/updatePro" method="post">
                                ...
                                <table class="table table-infobord" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tr>
                                            <th>회원ID</th>
                                            <td><input type="text" name="member_id" value="${memberDTO.member_id}" readonly></td>
                                        </tr>
                                        <tr>
                                            <th>비밀번호</th>
                                            <td><input type="password" name="member_pass" value="${memberDTO.member_pass}"></td>
                                        </tr>
                                        <tr>
                                            <th>이름</th>
                                        ...
                                        <tr>
                                            <th>이메일</th>
                                            <td><input type="text" name="member_email" value="${memberDTO.member_email}"></td>
                                        </tr>
                                        <tr>
                                            <th>주소</th>
                                            <td><input type="text" name="member_address" value="${memberDTO.member_address}"></td>
                                        </tr>
                                        <tr>
                                            <th>회원등급</th>
                                            <td>
       										<select id="memberGrade" name="member_grade">
            									<c:forEach var="memberG" items="${gradeList}">
                									 <option value="${memberG.member_grade}"
                										 <c:if test="${memberDTO.member_grade == memberG.member_grade}">
                        								  selected="selected"
                    						 			 </c:if>
                								>${memberG.member_grade}</option>
            									</c:forEach>
        									</select>
        									</td>                                          
                                        </tr>
            ...
            <!-- Footer -->
            <jsp:include page="/WEB-INF/views/inc/bottom1.jsp"/>
            <!-- End of Footer -->
