<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <ul class="navbar-nav bg-gradient-sidebar sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${pageContext.request.contextPath}/admin/member/index">
                ...
                <div class="sidebar-brand-text mx-3">OSTicket</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="${pageContext.request.contextPath}/main/main">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages5" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="${pageContext.request.contextPath}/inquiry/Imain">공식홈페이지 고객센터</a>
                    </div>
                </div>
            </li>
