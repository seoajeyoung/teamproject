							...
							<div class="sect-person-info">
								...
								<div class="box-contents newtype" style="width: 520px;">
									<div class="person-info">
										<strong>${memberDTO.name}님</strong> <em>${sessionScope.id}</em> <span>닉네임 :
											${memberDTO.nickname} </span>
									</div>
									<div class="grade-info">
										...
										<p
											...
											고객님은 <strong class="txt-purple">${memberDTO.grade}</strong> 입니다.
							...
							<div class="cols-benefit-info">
								<div class="col-my-coupon">
									...
									<ul>
										...
										<li><strong>OSTicket 할인쿠폰</strong> <span><em><a
													href="/user/mycgv/coupon/discount/list.aspx?g=1#contaniner">0</a></em>
												개</span></li>
										<li><strong>영화관람권</strong> <span><em><a
													href="/user/mycgv/coupon/movie-ticket/list.aspx?g=1#contaniner">0</a></em>
												개</span></li>
									</ul>
								</div>
								...
								<div class="col-one-point">
									...
									<ul>
										<li><strong>OSTicket 사용가능 포인트</strong> <span><em
												class="txt-maroon"><a
													href="/user/mycgv/cjone-point/pointlist.aspx">167</a></em> 점</span></li>
									</ul>
									<!-- 2022.11.15 VIP 1차 개편 관련 수정-->
									<div class="myCgv_content">
										<h3>VIP 점수</h3>
										<ul>
											<li><strong>VIP 누적 점수 </strong> <span>0/10,000점</span></li>
										</ul>
									</div>
