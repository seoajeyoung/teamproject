    ...
    <div class="ad-area">
		...
		<div class="col-detail">
			<div class="customer_top">
				...
				<p class="stit">회원님들께서 가장 자주하시는 질문을 모았습니다. <br>문의 전 궁금하신 내용에 대해 검색해보세요.</p>
			</div>
           ...
           <c:forEach var="inquiryDTO" items="${inquiryList}">
				<tbody>
                        ...
                        <tr class="first">
                            <!--순번 오름차순으로 변경-->
						    <td>${inquiryDTO.inquiry_num}</td>
                            <td>${inquiryDTO.member_num}</td>
						    <td id="title0" class="txt"><a href="${pageContext.request.contextPath}/inquiry/content?inquiry_num=${inquiryDTO.inquiry_num}">${inquiryDTO.inquiry_name}</a></td>
						    <td class="num">${inquiryDTO.inquiry_type}</td>
					    </tr>
