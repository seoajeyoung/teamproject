...
<head>
<meta charset="UTF-8">
<title>inquiry/updateoften.jsp</title>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEdAAWD9Aa/hRH7d0EBA0LTEkADQd2cmKM3DmSS0q8fAL1AFthsxU3vl4YGjIP3SMsaT/LOxY5vxQes7QbmZvYFP+TepAzD3rjRF5ef/g5kCYWib1CrFP5H1XKS8pNUiQOw6h/NbmNt">
                ...
                <!-- 팝업끝 -->
			    <form id="form1" name="form1" action="${pageContext.request.contextPath}/inquiry/oftenUpdatePro" method="post" novalidate="novalidate" enctype="multipart/form-data">
					<input type="hidden" name="OF_NUM" value="${often.OF_NUM}">
...
<!-- 									</tr> -->
									...
									<tr>
										...
										<td colspan="3">
											<input type="text" id="inp_title" name="OF_NAME" class="inp01" style="width: 672px;" value="${often.OF_NAME }">
										</td>
									</tr>
									<tr>
